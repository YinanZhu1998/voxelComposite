...
namespace DendroGH
{
    ...
    public class DendroVolume : IDisposable
    {
        ...
        [DllImport("DendroAPI.dll", CallingConvention = CallingConvention.Cdecl)]
        static public extern bool CreateSphereFromOnePoint(IntPtr grid, double center_x, double center_y, double center_z, double radius);

        //[DllImport("DendroAPI.dll", CallingConvention = CallingConvention.Cdecl)]
        //static public extern bool CreateSphere(IntPtr grid, double[] points, int pCount, double[] radii, int rCount, double voxelSize, double bandwidth);
        ...
        //[DllImport("DendroAPI.dll", CallingConvention = CallingConvention.Cdecl)]
        //static public extern bool CreateSphereFromTwoPoint(IntPtr grid, double center_x, double center_y, double center_z, double radius);

        //cylinder
        [DllImport("DendroAPI.dll", CallingConvention = CallingConvention.Cdecl)]
        static public extern bool GenerateCylinder(IntPtr grid, double radius, double x1, double y1, double z1, double x2, double y2, double z2);

        //a series of cylinders
        [DllImport("DendroAPI.dll", CallingConvention = CallingConvention.Cdecl)]
        static public extern bool GenerateCylinders(IntPtr grid, double length_mm, double width_mm, double height_mm, double num);

        //2021.8.4 after graduation fibers
        [DllImport("DendroAPI.dll", CallingConvention = CallingConvention.Cdecl)]
        static public extern bool GenerateFibers(IntPtr grid, double aspectRatioMean, double aspectRatioDe, double diameterMean, double diameterDe, double orientationMean, double orientationDe, double volumeFraction);
        ...
        ///// sphere1 constructor
        ///// </summary>
        //public DendroVolume(double radius, double center_x,double center_y,double center_z, DendroSettings vSettings)
        //{
        //    // pinvoke grid creation
        //    this.Grid = DendroCreate();
        //    this.Display = new Mesh();

        //    this.IsValid = this.GenerateSphere(radius,center_x,center_y,center_z, vSettings);
        //}

        ///// <summary>
        ///// sphere constructor 2
        ///// </summary>
        //public DendroVolume(double center_x, double center_y, double center_z, double radius)
        //{
        //    // pinvoke grid creation
        //    this.Grid = DendroCreate();
        //    this.Display = new Mesh();

        //    this.IsValid = this.CreateSphereFromPoint(center_x, center_y, center_z, radius);
        //}
        ...
        /// </summary>
        public DendroVolume(double radius, double x1, double y1, double z1, double x2, double y2, double z2)
        {
            // pinvoke grid creation
            this.Grid = DendroCreate();
            this.Display = new Mesh();

            this.IsValid = this.CreateCylinderFromTwoPoint(radius, x1,y1,z1,x2,y2,z2);
        }
        */

        //random cylinder cylinder cylinder
        /// <summary>
        /// cylinder constructor
        /// </summary>
        public DendroVolume(double length_mm, double width_mm, double height_mm,  double num)
        {
            // pinvoke grid creation
            this.Grid = DendroCreate();
            this.Display = new Mesh();
            this.IsValid = this.CreateCylinderFromRandomPoint(length_mm,width_mm,  height_mm,   num);
        }

        //2021.8.4 after graduation fibers
        public DendroVolume(double aspectRatioMean, double aspectRatioDe, double diameterMean, double diameterDe, double orientationMean, double orientationDe, double volumeFraction)
        {
            this.Grid = DendroCreate();
            this.Display = new Mesh();
            this.IsValid = this.FibersGenerator( aspectRatioMean,  aspectRatioDe, diameterMean, diameterDe,  orientationMean, orientationDe,  volumeFraction);
        }
        ...
        public bool AddSphere(double x, double y, double z, double radius)
        {
            // pinvoke grid creation
            ...
            {
                this.IsValid = CreateSphereFromOnePoint(this.Grid, x, y, z, radius);
        ...
        ///// <summary>
        ///// create a sphere by radius and its center 
        ///// </summary>
        ///// <remark>must supply a single radius value </remark>
        ///// <param name="radius_mm">radius of the sphere</param>
        ///// <param name="center_x">x coordinate of the center</param>
        ///// <param name="center_y">y coordinate of the center</param>
        ///// <param name="center_z">z coordinate of the center</param>
        ///// <returns>boolean value for whether volume was built successfully</returns>
        //public bool GenerateSphere(double radius_mm, double center_x, double center_y, double center_z, DendroSettings vSettings)
        //{
        ...
        //        this.IsValid = CreateSphere(this.Grid, points, points.Length, radius, radius.Length, vSettings.VoxelSize, vSettings.Bandwidth);
        ...
        ///// <summary>
        ///// create a sphere by radius and its center (openvdb cookbook method 1)
        ///// </summary>
        ///// <remark>must supply a single radius value </remark>
        ///// <param name="radius_mm">radius of the sphere</param>
        ///// <param name="center_x">x coordinate of the center</param>
        ...
        ///// <param name="center_z">z coordinate of the center</param>
        ///// <returns>boolean value for whether volume was built successfully</returns>
        //public bool CreateSphereFromPoint(double center_x, double center_y, double center_z, double radius)
        //{
        ...
        //    else
        //    {
        //        this.IsValid = CreateSphereFromOnePoint(this.Grid, center_x,center_y,center_z,radius);
        ...
        ///// <summary>
        ///// create a sphere by radius and its center (openvdb cookbook method 2)
        ///// </summary>
        ///// <remark>must supply a single radius value </remark>
        ...
        ///// <param name="center_z">z coordinate of the center</param>
        ///// <returns>boolean value for whether volume was built successfully</returns>
        //public bool CreateSphereFromPoint(float center_x, float center_y, float center_z, int radius)
        //{
        ...
        ///// <summary>
        ///// create a sphere by radius and its center (openvdb cookbook method 3)---add sphere
        ///// </summary>
        ///// <remark>must supply a single radius value </remark>
        ///// <param name="radius">radius of the sphere</param>
        ///// <param name="center_x">x coordinate of the center</param>
        ...
        ///// <param name="center_z">z coordinate of the center</param>
        ///// <returns>boolean value for whether volume was built successfully</returns>
        //public bool CreateSphereFromPoints(double center_x, double center_y, double center_z, double radius)
        //{
        ...
        //    else
        //    {
        //        this.IsValid = CreateSphereFromTwoPoint(this.Grid, center_x, center_y, center_z, radius);
        ...
        public bool CreateCylinderFromTwoPoint(double radius, double x1, double y1, double z1, double x2, double y2, double z2)
        {
            ...
            {
                this.IsValid = GenerateCylinder(this.Grid, radius,x1,y1,z1,x2,y2,z2);
        ...
        /// <summary>
        /// create some cylinder by radius and two points
        /// </summary>

        public bool CreateCylinderFromRandomPoint(double length_mm, double width_mm, double height_mm,  double num)
        {
            ...
            {
                this.IsValid = GenerateCylinders(this.Grid, length_mm, width_mm,  height_mm,  num);
        ...
        //2021.8.4 after graduation fibers
        public bool FibersGenerator(double aspectRatioMean, double aspectRatioDe, double diameterMean, double diameterDe, double orientationMean, double orientationDe, double volumeFraction)
        {
                this.IsValid = GenerateFibers(this.Grid, aspectRatioMean,  aspectRatioDe, diameterMean, diameterDe, orientationMean, orientationDe, volumeFraction);
