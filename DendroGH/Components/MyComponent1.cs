...
//            pManager.AddGenericParameter("Settings", "Settings", "Settings for converting different geometry types to and from volumes", GH_ParamAccess.item);
//        }
...
//            if (!DA.GetData(4, ref vSettings)) return;


//            DendroVolume sphere = new DendroVolume(radius,x,y,z,vSettings);
